export const ROOT_CONTAINER_CLASS_NAME = 'respark_root';
export const DESIGN_LAYER_ID = 'respark_design-layer';
export const TRANSFORMERS_LAYER_ID = 'respark_transformers-layer';
export const IMAGE_NODE_ID = 'respark_original-image';
export const NODES_TRANSFORMER_ID = 'respark_nodes-transformer';
