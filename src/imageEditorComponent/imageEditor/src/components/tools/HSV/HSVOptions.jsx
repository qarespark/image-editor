...
const HSVOptions = ({ t }) => {
  ...
  return (
    <>
      <StyledSliderContainer className="respark_hue-option-wrapper">
        <Label className="respark_hue-option-label">{t('hue')}</Label>
        <Slider
          className="respark_hue-option"
          min={0}
          step={1}
          max={259}
      ...
      <StyledSliderContainer className="respark_saturation-option-wrapper">
        <Label className="respark_saturation-option-label">{t('saturation')}</Label>
        <Slider
          className="respark_saturation-option"
          min={-2}
          step={0.5}
          max={10}
      ...
      <StyledSliderContainer className="respark_value-option-wrapper">
        <Label className="respark_value-option-label">{t('value')}</Label>
        <Slider
          className="respark_value-option"
          min={-2}
          step={0.1}
          max={2}
