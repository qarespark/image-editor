...
import LockOutline from '../../../element/icons/lock-outline';
import UnlockOutline from '../../../element/icons/unlock-outline';
...
const Resize = ({ onChange, currentSize, hideResetButton, alignLeft }) => {
  ...
  return (
    <StyledResizeWrapper
      className="respark_resize-tool-options"
      alignLeft={alignLeft}
    >
      <StyledResizeInput
        className="respark_resize-width-option"
      ...
      />
      <StyledXLabel className="respark_resize-x-label">x</StyledXLabel>
      <StyledResizeInput
        className="respark_resize-height-option"
      ...
      />
      <StyledRatioLockIcon
        className="respark_resize-ratio-locker"
      ...
      {!hideResetButton && (
        <Button
          className="respark_resize-reset-button"
          size="sm"
          onClick={
