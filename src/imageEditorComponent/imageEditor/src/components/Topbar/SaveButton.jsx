...
import SaveAs from '../../element/icons/save-as';
  ...
  return (
    <>
      ...
      {isModalOpened && (
        ...
        >
          <StyledFileNameInput
            className="respark_save-file-name-input"
          ...
          />
          <StyledFileExtensionSelect
            className="respark_save-extension-selector"
            onChange={(ext) =>
          ...
          {isQualityAcceptable && (
            <StyledQualityWrapper className="respark_save-quality-wrapper">
          ...
          <StyledResizeOnSave className="respark_save-resize-wrapper">
